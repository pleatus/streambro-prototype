...
<main>
	...
	<div class="btn-container">
		...
		<button class="manCount centre-elem danger" onclick="resetCountor();">Reset</button>
				...
				<input name="goal" id="goalLabel" type="number">
				<button class="labeller" onclick="changeGoal();">Change Goal</button>
				</div>
	...
	<script src="dspGoal.js"></script>
	<script src="goalControl.js"></script>
</body>
</html>